...
# TODO
- Format the created at date and update at dates, it is easy, but when the user sends it back, jersey can not
deserialize it appropiatly, I have to write a routine to make that biding manually.
